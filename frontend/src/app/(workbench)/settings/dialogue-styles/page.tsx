...
import type { DialogueStyle } from "@/lib/dialogue-style-api";

export default function DialogueStylesPage() {
  const { styles, isLoading, create, update, remove } = useDialogueStyles();
  const [modalOpen, setModalOpen] = useState(false);
  const [editingItem, setEditingItem] = useState<DialogueStyle | null>(null);
  ...
  const handleEdit = (item: DialogueStyle) => {
    setEditingItem(item);
    setModalOpen(true);
  };
  ...
  const handleDelete = async (item: DialogueStyle) => {
